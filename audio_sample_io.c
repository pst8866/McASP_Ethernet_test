...
static Void createStreams()
{
    ...
    status = aic31MdCreateChan(&hAicChannel, hAicDev, remName,mode,
                               (Ptr)(&AIC31_con8000),(IOM_TiomCallback)&mcaspAppCallback, NULL); //mcaspcallback argument is NULL and devp(hAicDev) is AIC31 Object
    ...
    /* 2. SEM Initializations */
       ...
       /* Call createStream function to create I/O streams                       */
          ...
          for (i32Count = 0; i32Count >= 0; i32Count++)
          {
               ...
               */
          //   int i = aic31CtrlBusRead((Aic31_Object*)hAicDev, &adcData);
