...
%******** Create a panel for operations that can be performed*****%
 ...
 %********CHange in the properties of the axes are done here**********%
    ...
    uPlotraw1 = animatedline(hraw1ax,'Color','m', 'MaximumNumPoints', 100,'LineWidth',1);
...
xmax = 100;
  ...
  while(1)      
        data = fread(udpClient,400,'double');
        res_data = reshape(data,[4,100]);
        
                signal_1 = res_data(1,1:100);
