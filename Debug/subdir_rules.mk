...
build-1524312513:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1524312513-inproc

build-1524312513-inproc: ../mcasp_ethernet.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1524312513 ../mcasp_ethernet.cfg
configPkg/compiler.opt: build-1524312513
configPkg/: build-1524312513
